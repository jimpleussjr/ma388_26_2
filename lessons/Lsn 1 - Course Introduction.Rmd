...
mike.powell@westpoint.edu 

Thayer Hall Room 237

845-938-0480

PACE: email, Teams, drop-in, phone, check Arvin courts...
...
knitr::include_graphics("intro_pic_1.png")
```

\vspace{.25in}

```{r, echo=FALSE, out.height="45%", fig.align='center'}
knitr::include_graphics("intro_pic_2.png")
```
...
![](marchi.jpg){width=30%} ![](costa.jpg){width=30%}
