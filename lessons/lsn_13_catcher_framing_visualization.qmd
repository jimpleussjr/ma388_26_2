...
\textit{Do you think some catchers are better than others at framing pitches, and how important is this skill?}

* [Video 1](https://www.youtube.com/watch?v=tkjCx56nFlQ)

* [Video 2](https://www.youtube.com/watch?v=kQdkeYXHh6Y) 

\textit{How could we investigate whether some catchers are better than others? List some challenges with answering this question with data.}
...
\textit{Does it appear catchers make a difference?}

\vspace{1in}

\textit{Now that we've been talking about this for a while, what new considerations come to mind?}

\vspace{1in}

\textit{How could a model-based approach improve upon this analysis?}
