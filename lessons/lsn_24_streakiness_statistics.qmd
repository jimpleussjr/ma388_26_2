...
```{r}
# Load the data.
fields_file = "master/data/fields.csv"
data_file = "master/data/all2011.csv"
site = "https://raw.githubusercontent.com/maxtoki/baseball_R/"
fields <- read_csv(file = paste(site, fields_file, sep =""))
retro2011 <- read_csv(file = paste(site, data_file, sep = ""),
