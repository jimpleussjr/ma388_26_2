...
```{r, include = FALSE}
# Data for this lesson is an extract from the complete 2023 season.
# df <- read_csv("statcast2023.csv") |>
#   filter(type == "X") |>
#   select(batter, pitcher, stand, events, home_team, away_team, plate_x, plate_z, 
# hc_x, hc_y, launch_speed, launch_angle, if_fielding_alignment, hit_distance_sc) |>
#   mutate(hit = events %in% c("single", "double", "triple", "home_run"))
# write_csv(df, "statcast2023_bip.csv")
```
...
# statcast_2023 <- map2_dfr(date_chunks, date_ends, ~{
